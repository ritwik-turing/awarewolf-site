...
- `brand/awarewolf_identity_v11.webp` is the current full emblem and `aware._wolf_` lockup. Its lab-teal bridge keeps the wave visually dominant and uses only `Ĥψ`—the Hamiltonian operator acting on the wavefunction—at the centre.
- `brand/awarewolf_mark_v11.webp` is the current emblem-only navigation mark.
