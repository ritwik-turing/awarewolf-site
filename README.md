...
- `brand/awarewolf_identity_v12.webp` is the current full emblem and `aware._wolf_` lockup. Its lab-teal bridge is a localized quantum wave packet: oscillations peak near the centre and taper toward both edges. It uses only `Ĥψ`—the Hamiltonian operator acting on the wavefunction—at the centre.
- `brand/awarewolf_mark_v12.webp` is the current emblem-only navigation mark.
